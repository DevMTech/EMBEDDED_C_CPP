/***************************************************************
* A program to declare, defne, and use a bank account class *
***************************************************************/
#include <iostream>
#include <cassert>
using namespace std;
...
/***************************************************************
* Class Defnition (Declaration of all members) *
***************************************************************/
class Account
{
	private:
...
/***************************************************************
* Defnition of all member functions *
***************************************************************/
...
:balance (bal)
{
	...
	assert (false); // ensures that no account is opened with a negative balance
	}
	base++;
...
//Copy Constructor 
// delete => prevents one account(object) from getting copied to another(object) 
//Account (const Account& acc) = delete; // compiles for C++11 
