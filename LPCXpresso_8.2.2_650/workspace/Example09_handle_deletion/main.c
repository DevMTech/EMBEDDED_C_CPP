...
//
//
//lecture - using the task handle and deleting a task
//
//lecture - as per rules of FreeRTOS, task must not do a regular function return
//          it must either be written with an infinite loop(continuous or periodic),
//          or must explicitly execute a vTaskDelete()
//
//
//
