...
//lecture - same as example1 - in this case, we are executing same
//          task method, with different parameters
...
//lecture - only one difference from the first example - a parameter is passed to the
//          task method/entry point
