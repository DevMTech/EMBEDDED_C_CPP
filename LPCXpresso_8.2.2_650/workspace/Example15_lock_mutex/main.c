...
//
//
//lecture - example used to illustrate mutex ???
//
//lecture - refer to semphr.h and queue.c for more comments
//
//
...
int main( void )
{
	//
	//
	//lecture - a mutex is allocated, initialized and set to UNLOCKED state -
	//          refer to semphr.h and queue.c for methods and comments
	//
...
//
//
//lecture - another implementation of a thread-safe version of console IO -
//          the system implements, using scheduler lock - refer to basic_io.c
//
//
static void prvNewPrintString( const portCHAR *pcString )
{
static char cBuffer[ mainMAX_MSG_LEN ];
    ...
    //
    //
    //lecture - refer to semaphr.h and queue.c for more details and comments
    //
    //
    //lecture - xSemaphore() take is a blocking call and xSemaphoreGive is a non-blocking call
    //
    //
