...
//
//
//lecture - this example illustrates preemptions without interrupt events - in this case,
//          changing priorities leads to preemptions
//
//
//
//lecture - this example can be used to collect time-stamps and
//          measuring latencies during preemptions - context switching ??
//
//          are the measured values acceptable ??
//
//
...
unsigned portBASE_TYPE uxPriority;
	...
	for( ;; )
	{
		...
		//
		//
		//lecture - measure the time-stamp before invoking the system API
		//
		//
		...
		//
		//lecture - measure the time-stamp here to check the latency involved,due to
		//          preemption
		//
		//
	}
...
unsigned portBASE_TYPE uxPriority;
	...
	"return our own priority". */
    //
    //lecture - measure the time-stamp here to find, when the task is scheduled ??
    //
	...
	for( ;; )
	{
	    ...
	    //lecture - measure the time-stamp here - to measure latency ???

		vTaskPrioritySet( NULL, ( uxPriority - 2 ) );
        //
		//lecture - measure the time-stamp here - to measure latency involved, due to
		//          preemption
	}
}
/*-----------------------------------------------------------*/
