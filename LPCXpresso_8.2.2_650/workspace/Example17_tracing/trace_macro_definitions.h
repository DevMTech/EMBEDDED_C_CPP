...
//
//
//lecture - these hook macros are useful for performance measurements
//          we can possibly combine these with other examples that need
//          performance measurements ???
//
//lecture - we can possibly modify this code to use a gatekeeper task
//          that will print the values to the console - we may involve a
//          a message queue as well !!!
//
