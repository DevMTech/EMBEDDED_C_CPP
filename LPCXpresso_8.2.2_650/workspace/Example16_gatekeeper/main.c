...
//
//
//lecture - illustration of so called gate-keeper task - another way of resource management
//
//lecture - involves 2 Tasks, and a Tick Hook, which helps provide interrupt context
//
//
//lecture - we may need to use this Gate keeper task to manage diagnostics via a queue -
//          also, make sure the priority of this task is very low and also that it runs
//          less frequently than our real-time tasks !!!
//
//
//
//
...
//
//
//lecture - an example of using a Tick Hook - this will enable certain testing and debugging
//
//
//
