...
#include "LPC17xx.h"
//
//lecture - this is an example that covers interrupts and queues
//
...
int main( void )
{
	...
	//
	//
    //lecture - refer to queue.h and queue.c for more details
	//
	//
...
static const char *pcStrings[] =
{
    ...
    //
    //
    //lecture - another example of using ISR safe functions from ISR
    //          what is so special in implementation of ISR safe functions ???
    //
    //          refer to queue.h and queue.c for more details ??
    //
    //
