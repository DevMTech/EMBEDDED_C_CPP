...
//
//
//lecture - same as example12, but using counting semaphore and multiple
//          events being generated from the ISR
//
//
...
interrupt is used, which happens to be the watchdog on the LPC17xx. */
...
int main( void )
{
	...
	//
	//
	//lecture - counting semaphores in this context are strictly managed - the maximum count
	//          count cannot be exceeded, during run-time !!!
	//
...
static void vHandlerTask( void *pvParameters )
{
	...
	for( ;; )
	{
		...
		//
		//lecture - most comments mentioned in the binary semaphore apply here as well
		//
		//
...
portBASE_TYPE xHigherPriorityTaskWoken = pdFALSE;
    ...
    //
    //lecture - you may have to slightly modify the code to remoove a bug ???
    //
    //lecture - refer to comments, in the previous binary semaphore example -
    //          also refer to semphr.h and queue.c for more comments and details
    //
    ...
    //
    //
    //lecture - refer to portmacro.h
    //
    //
    //lecture - this API is invoked to pass control to scheduler, if a higher priority task
    //          is invoked !!!
    //
    //
    //
