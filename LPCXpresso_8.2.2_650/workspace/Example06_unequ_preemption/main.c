...
*/
//
//lecture - here we are having continuous and periodic tasks - periodic task is
//          of higher priority than continuous tasks !!!
//
//lecture - we need to print time-stamps, to show certain details
//          we need to add time-stamp details, along with the existing
//          diagnostics !!!
//lecture - add time-stamp measurement to this code, based on Example05
//
//lecture - it is always better to minimize the diagnostics - they will introduce unnecessary
//          latencies to measured parameters !!!
//
//
//
...
portTickType xLastWakeTime;
	...
	for( ;; )
	{
		...
		//lecture - we must use time-stamps to check the latencies

		vTaskDelayUntil( &xLastWakeTime, ( 10 / portTICK_RATE_MS ) );

		//lecture - we must use measure time-stamps to check latencies

		/* Print out the name of this task. */
		vPrintString( "Periodic task is running..........\n" );

		//lecture - we must measure time-stamps to check latencies
